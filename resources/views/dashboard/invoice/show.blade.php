...
<head>
  ...
  <style>
    body {
      ...
      font-size: 12pt; /* Use pt for print consistency */
      margin: 0;
    ...
    @media print {
      @page {
        size: A4;
        margin: 15mm; /* Consistent margins for A4 */
      }
      body {
        margin: 0;
        padding: 0;
      ...
      .details-box, .invoice-data-table, .summary-box {
        width: 100%;
        max-width: 210mm; /* Fit within A4 with margins */
      }
    ...
    .invoice-data-table td, .invoice-data-table th {
      word-wrap: break-word;
      max-width: 50mm; /* Prevent columns from becoming too wide */
    }
    ...
    .invoice-data-table th, .invoice-data-table td {
      width: 11.98%; /* Default width for all columns except description */
      word-wrap: break-word;
      max-width: 50mm; /* Prevent columns from becoming too wide */
    }
    .invoice-data-table th.description-column, .invoice-data-table td.description-column {
      width: 16.17%; /* 35% wider than other columns */
    }
  </style>
</head>
<body>
