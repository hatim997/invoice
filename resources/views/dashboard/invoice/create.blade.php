        ...
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.invoices.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('agency_licence_number') is-invalid @enderror" type="text"
                                ...
                                value="{{ old('agency_licence_number') }}" />
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('service_description') is-invalid @enderror" type="text"
                                ...
                                placeholder="{{ __('Enter service description') }}">{{ old('service_description') }}</textarea>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('unit_price') is-invalid @enderror" step="any"
                                ...
                                placeholder="{{ __('Enter unit price') }}" autofocus value="{{ old('unit_price') }}" />
                            @error('unit_price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('total') is-invalid @enderror" step="any"
                                ...
                                placeholder="{{ __('Enter total') }}" autofocus value="{{ old('total', 0.0) }}" />
                            @error('total')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Add Invoice') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
